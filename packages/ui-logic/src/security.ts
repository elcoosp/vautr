...
/**
 * Human-friendly strength meter (registers a 0–7 score, label, colour token and
 * suggestions) for interactive password fields. Mirrors the VTR-001 web
 * enhancement so extension / mobile / desktop clients share one implementation.
 */
...
export function evaluatePasswordStrength(password: string): PasswordStrength {
  ...
  if (
    /(0123|1234|2345|3456|4567|5678|6789|abcd|bcde|cdef|qwerty|password|abc123|iloveyou)/i.test(
      password,
    )
  ) {
    score -= 2;
