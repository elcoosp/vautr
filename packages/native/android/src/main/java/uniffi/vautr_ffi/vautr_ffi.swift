...
public protocol MobileClientProtocol: AnyObject, Sendable {
     ...
     */
    func connectSync(baseUrl: String, token: String, userId: String) throws 
     ...
     */
    func deleteItem(uuid: String) throws 
     ...
     */
    func getOverview(uuid: String) throws  -> String
     ...
     */
    func listOverviews() throws  -> String
     ...
     */
    func login(serverUrl: String, username: String, password: String) throws  -> String
    
    /**
     * Delegate copy/autofill to the native platform handler.
     */
    func performAction(action: CoreAction) throws 
     ...
     */
    func register(serverUrl: String, username: String, password: String) throws  -> String
     ...
     */
    func setPlatformHandler(handler: PlatformActionHandler) 
     ...
     */
    func unlock(rawKey: Data, localGen: UInt64) throws 
     ...
     */
    func unlockWithPassword(mp: String, kdfSaltB64: String, wrappedSvkB64: String, userId: String, localGen: UInt64) throws 
    
    /**
     * Unlock directly with a raw 32-byte vault key + the local key generation.
     */
    func unlockWithRawKey(rawKey: Data, localGen: UInt64) throws 
...
public convenience init(dbPath: String)throws  {
     ...
     */
public static func initialize(dbPath: String)throws  -> MobileClient  {
    return try  FfiConverterTypeMobileClient_lift(try rustCallWithError(FfiConverterTypeFfiError_lift) {
    uniffi_vautr_ffi_fn_constructor_mobileclient_initialize(
        FfiConverterString.lower(dbPath),$0
    )
})
}
...
open func addGroupMember(groupJson: String, memberUuid: String, memberPubkeyB64: String)throws  -> FfiWrappedGroupKey  {
     ...
     * Connect sync transport to the server.
     */
open func connectSync(baseUrl: String, token: String, userId: String)throws   {try rustCallWithError(FfiConverterTypeFfiError_lift) {
...
open func decryptGroupItem(groupJson: String, itemUuid: String, ctB64: String)throws  -> Data  {
     ...
     * Delete an item by uuid.
     */
open func deleteItem(uuid: String)throws   {try rustCallWithError(FfiConverterTypeFfiError_lift) {
...
open func ensureSharingKey()throws  -> String  {
     ...
     * Get a single overview by uuid string. Returns JSON `DecryptedOverview`.
     */
open func getOverview(uuid: String)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeFfiError_lift) {
...
open func isLocked() -> Bool  {
     ...
     * `DecryptedOverview`. Mirrors the web worker's empty-query search.
     */
open func listOverviews()throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeFfiError_lift) {
...
open func lock()  {try! rustCall() {
     ...
     * if the password is correct but the local vault is missing).
     */
open func login(serverUrl: String, username: String, password: String)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeFfiError_lift) {
     ...
     * Delegate copy/autofill to the native platform handler.
     */
open func performAction(action: CoreAction)throws   {try rustCallWithError(FfiConverterTypeFfiError_lift) {
    uniffi_vautr_ffi_fn_method_mobileclient_perform_action(
            self.uniffiCloneHandle(),
        FfiConverterTypeCoreAction_lower(action),$0
    )
}
}
     ...
     * `login` can re-derive the vault key.
     */
open func register(serverUrl: String, username: String, password: String)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeFfiError_lift) {
...
open func releaseSecret(handle: UInt64)throws   {try rustCallWithError(FfiConverterTypeFfiError_lift) {
     ...
     * for calling `release_secret` when it unmounts.
     */
open func renderSecretInOverlay(handle: UInt64)throws   {try rustCallWithError(FfiConverterTypeFfiError_lift) {
     ...
     * Reveal a secret, returning an opaque handle (secret stays in Rust).
     */
open func revealSecret(uuid: String)throws  -> UInt64  {
     ...
     * Rotate the vault key to `new_gen`.
     */
open func rotateKey(newGen: UInt64)throws   {try rustCallWithError(FfiConverterTypeFfiError_lift) {
    uniffi_vautr_ffi_fn_method_mobileclient_rotate_key(
            self.uniffiCloneHandle(),
        FfiConverterUInt64.lower(newGen),$0
    )
}
}
     ...
     * is the vault key generation that encrypted it.
     */
open func saveItem(uuid: String, encKeyGen: UInt64, payload: Data)throws   {try rustCallWithError(FfiConverterTypeFfiError_lift) {
    uniffi_vautr_ffi_fn_method_mobileclient_save_item(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(uuid),
        FfiConverterUInt64.lower(encKeyGen),
     ...
     * FTS5 search. Returns JSON-encoded `Vec<DecryptedOverview>`.
     */
open func search(query: String)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeFfiError_lift) {
...
open func secureEnclaveBridge() -> SecureEnclaveBridge?  {
     ...
     * Register the native platform handler (clipboard / autofill).
     */
open func setPlatformHandler(handler: PlatformActionHandler)  {try! rustCall() {
    uniffi_vautr_ffi_fn_method_mobileclient_set_platform_handler(
            self.uniffiCloneHandle(),
        FfiConverterTypePlatformActionHandler_lower(handler),$0
    )
}
}
...
open func sharingSecret() -> String?  {
     ...
     * Run a metadata-first sync pull + selective payload download.
     */
open func sync()throws   {try rustCallWithError(FfiConverterTypeFfiError_lift) {
     ...
     * unlock, crypto.md §6). `local_gen` is the local vault key generation.
     */
open func unlock(rawKey: Data, localGen: UInt64)throws   {try rustCallWithError(FfiConverterTypeFfiError_lift) {
    uniffi_vautr_ffi_fn_method_mobileclient_unlock(
            self.uniffiCloneHandle(),
        FfiConverterData.lower(rawKey),
        FfiConverterUInt64.lower(localGen),$0
    )
}
}
     ...
     * from the server auth bootstrap; `user_id` is the server user uuid.
     */
open func unlockWithPassword(mp: String, kdfSaltB64: String, wrappedSvkB64: String, userId: String, localGen: UInt64)throws   {try rustCallWithError(FfiConverterTypeFfiError_lift) {
    uniffi_vautr_ffi_fn_method_mobileclient_unlock_with_password(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(mp),
        FfiConverterString.lower(kdfSaltB64),
        FfiConverterString.lower(wrappedSvkB64),
     ...
     * Unlock directly with a raw 32-byte vault key + the local key generation.
     */
open func unlockWithRawKey(rawKey: Data, localGen: UInt64)throws   {try rustCallWithError(FfiConverterTypeFfiError_lift) {
...
private let initializationResult: InitializationResult = {
    ...
    if (uniffi_vautr_ffi_checksum_method_mobileclient_connect_sync() != 64635) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_vautr_ffi_checksum_method_mobileclient_delete_item() != 5076) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_vautr_ffi_checksum_method_mobileclient_get_overview() != 53922) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vautr_ffi_checksum_method_mobileclient_is_locked() != 57584) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vautr_ffi_checksum_method_mobileclient_list_overviews() != 56715) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vautr_ffi_checksum_method_mobileclient_lock() != 39166) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vautr_ffi_checksum_method_mobileclient_login() != 3575) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vautr_ffi_checksum_method_mobileclient_perform_action() != 32794) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vautr_ffi_checksum_method_mobileclient_register() != 32719) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vautr_ffi_checksum_method_mobileclient_release_secret() != 20178) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vautr_ffi_checksum_method_mobileclient_render_secret_in_overlay() != 1426) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vautr_ffi_checksum_method_mobileclient_reveal_secret() != 61999) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vautr_ffi_checksum_method_mobileclient_rotate_key() != 46303) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vautr_ffi_checksum_method_mobileclient_save_item() != 56024) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vautr_ffi_checksum_method_mobileclient_search() != 55540) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vautr_ffi_checksum_method_mobileclient_secure_enclave_bridge() != 35208) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vautr_ffi_checksum_method_mobileclient_set_platform_handler() != 48143) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_vautr_ffi_checksum_method_mobileclient_sync() != 50088) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vautr_ffi_checksum_method_mobileclient_unlock() != 52759) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vautr_ffi_checksum_method_mobileclient_unlock_with_password() != 39434) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vautr_ffi_checksum_method_mobileclient_unlock_with_raw_key() != 44722) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_vautr_ffi_checksum_constructor_mobileclient_initialize() != 33899) {
        return InitializationResult.apiChecksumMismatch
    }
