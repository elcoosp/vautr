// Feature-tour steps (VTR-077). Anchored walkthrough contract lives in
// docs/onboarding/tour.md. Each step targets a stable `data-tour` id that the
// host UI marks on the real control; the TourOverlay highlights that element.
