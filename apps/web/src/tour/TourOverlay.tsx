...
/**
 * Anchored feature-tour overlay (VTR-077, web). Renders a dimmed scrim, a
 * highlight ring around the targeted `[data-tour]` element, and a positioned
 * card. Not built on OnboardJS — that engine has no element-anchor API.
 */
